...
import { INITIAL_PRODUCTS, INITIAL_STORE_SETTINGS, INITIAL_TRANSACTIONS, PRODUCT_CATALOG_VERSION, INITIAL_CATEGORIES } from './data/initialData.js';
...
import { ensureStore, loadDatabase, seedDatabase, upsertProduct, deleteProduct, syncCategories, saveSettings, saveShift, syncHeldOrders, commitSale, upsertTransaction, refundSale } from './lib/database.js';
