...
const handleExportCSV = () => {
    ...
    children: [
        ...
        _jsx("div", {
            className: "flex bg-slate-100 p-1 rounded-xl border border-slate-200 w-full sm:w-auto",
            children: [
                ...
                className: `flex-1 sm:flex-none px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${timeFilter === tab.id
